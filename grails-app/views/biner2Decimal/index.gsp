...
<div
        class="container d-flex flex-column align-items-center justify-content-center min-vh-100 py-4">
    <main class="w-100" style="max-width: 720px">
        <div class="card shadow-lg rounded-4">
            <header
                    class="card-header p-3 p-md-4 d-flex justify-content-between align-items-center">
            ...
            <div class="card-body p-3 p-md-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input
                                type="text"
                                id="output-value"
                                class="form-control form-control-lg bg-body-secondary"
                                readonly
                ...
                <div class="d-flex justify-content-end mb-3">
                    <button id="clear-button" class="btn btn-primary">
                        Bersihkan
                    </button>
                </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div
                            ...
                            <div class="accordion-body small text-body-secondary">
                                <p>
                                    <strong>Biner (Basis 2):</strong> Menggunakan digit 0 dan
                                1. Dasar dari komputasi digital.
                                </p>

                                <p>
                                    <strong>Desimal (Basis 10):</strong> Sistem bilangan yang
                                kita gunakan sehari-hari, digit 0-9.
                                </p>

                                <p>
                                    <strong>Heksadesimal (Basis 16):</strong> Menggunakan
                                digit 0-9 dan huruf A-F (A=10, B=11, ..., F=15). Sering
                                digunakan dalam pemrograman untuk representasi memori dan
                                warna.
                                </p>

                                <p>
                                    <strong>Oktal (Basis 8):</strong> Menggunakan digit 0-7.
                                Dulu lebih umum, sekarang kurang populer dibandingkan
                                heksadesimal.
                                </p>
                            </div>
                        </div>
